                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">@hiplatui</p>
                            </a>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Address: Linh Xuân, Thủ Đức, Việt Nam</p>
                            <p>Email: truongtuan208@gmail.com</p>
                            <p>Phone: +84941738394</p>
